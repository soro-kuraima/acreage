...
export default function PropertiesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setNoOfBhk(initialValues.noOfBhk);
    setPrice(initialValues.price);
    setBuiltUpArea(initialValues.builtUpArea);
    setDescription(initialValues.description);
    setAddress(initialValues.address);
    setPincode(initialValues.pincode);
    setCity(initialValues.city);
    setState(initialValues.state);
    setAgeOfProperty(initialValues.ageOfProperty);
    setPropertyType(initialValues.propertyType);
    setSalesType(initialValues.salesType);
    setFacing(initialValues.facing);
    setPropertyImages(initialValues.propertyImages);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, 'PropertiesCreateForm')}
      {...rest}>
      <TextField
        label="Title"
        isRequired={true}
